"""Command dashboard — Generates dashboard.md at vault root.

Aggregates pending tasks with aging, health score and orphans.
Uses direct imports (no subprocess) for better performance.
"""
...
def _build_dashboard(vault):
    """Builds dashboard.md content using direct imports."""
    ...
    if orphans:
        ...
        lines.append("")
        lines.append(f"_{len(orphans)} concept(s) without links:_")
        for o in orphans:
            lines.append(f"- `{o}`")
        lines.append("")
    ...
    lines.extend([
        "---", "",
        "> Auto-generated by `cli dashboard`. Do not edit manually.",
        f"> Last updated: {now}",
    ])

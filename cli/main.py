...
def build_parser():
    ...
    sp_search.add_argument("--include-handoffs", action="store_true", default=False,
                           help="With --todos: include type=Handoff checkboxes (frozen session state, not a live backlog)")
